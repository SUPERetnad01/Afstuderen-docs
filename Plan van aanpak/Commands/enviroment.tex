...
\newcommand{\SubquestionOne}{Wie zijn de stakeholders van het afstudeerproject?}
\newcommand{\SubquestionTwo}{Wat is de huidige software architectuur van Snakeware Cloud?}
