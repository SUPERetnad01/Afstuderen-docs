...
\newglossaryentry{Stored procedures}{
	...
	description = {Een stored procedure is een voorbereide database query's die gebruikt kunnen worden als functies in andere SQL query's of als alleenstaande query's},
