...
\newglossaryentry{Stored procedures}{
	...
	description = {Een stored procedure is een voorbereide database queries die gebruikt kunnen worden als functies in andere SQL queries of als alleen staande queries},
